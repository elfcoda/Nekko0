/* PrismJS 1.11.0
http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+c+bash+cpp+ruby+go+java+python&plugins=line-highlight+line-numbers+file-highlight+toolbar+jsonp-highlight+highlight-keywords+command-line+normalize-whitespace+show-language+copy-to-clipboard */
...
Prism.languages.cpp = Prism.languages.extend('c', {
	'keyword': /\b(?:alignas|alignof|asm|auto|bool|break|case|catch|char|char16_t|char32_t)\b/,
  'keyword-orange': /\b(?:class|compl|const|constexpr|const_cast|continue|decltype|default|delete|do)\b/,
  'keyword-blue': /\b(?:double|dynamic_cast|else|enum|explicit|export|extern|float|for|friend)\b/,
  'keyword-purple': /\b(?:goto|if|inline|int|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|long)\b/,
  'keyword-pink': /\b(?:mutable|namespace|new|noexcept|nullptr|operator|private|protected|public|register)\b/,
  'keyword-green': /\b(?:reinterpret_cast|return|short|signed|sizeof|static|static_assert|static_cast|struct|switch|template)\b/,
  'keyword-yellow': /\b(?:this|thread_local|throw|try|typedef|typeid|typename)\b/,
  'keyword-red': /\b(?:union|unsigned|using|virtual|void|volatile|wchar_t|while)\b/,
	'boolean': /\b(?:true|false)\b/,
...
Prism.languages.python = {
	...
	'keyword': /\b(?:as|assert|async|await|break|class|continue|def|del)\b/,
	'keyword-orange': /\b(?:elif|else|except|exec|finally|for|from|global|if)\b/,
	'keyword-blue': /\b(?:import|in|is|lambda|nonlocal|pass)\b/,
	'keyword-purple': /\b(?:print|raise|return|try|while|with|yield)\b/,
